            ...
            <v-col sm="10" class="mx-auto">
                <v-card class="pa-5">
                    ...
                    <v-form ref="form" @submit.prevent="updateForm" class="pa-5" enctype="multipart/form-data">
                        ...
                        <v-text-field label="VideoID" v-model="post.videoId" prepend-icon="mdi-view-list" :rules="rules"></v-text-field>
    ...
    methods: {
        ...
        async updateForm(){
            ...
            if(this.$refs.form.validate()){
                const response = await API.updatePost(this.$route.params.slug,formData);
